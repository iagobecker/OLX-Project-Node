...
module.exports = {
    ...
    addAction: async (req, res) => {
        ...
        if (price) { //float ex de estrutura: RS$8.000,35→para = 8000.35
    ...
    getList: async (req, res) => {
        ...
        const adsData = await Ad.find({ filters: filters })
    ...
    getItem: async (req, res) => {
        ...
        if (!ad) {
            res.json({ error: 'Produto inexixtente' });
            return;
        }
    ...
    editAction: async (req, res) => {
        ...
        if (!ad) {
            res.json({ error: 'Anúncio inexixtente' });
            return;
        }
        ...
        if (cat) {
            ...
            if (!category) {
                res.json({ error: 'Categoria inexixtente' });
                return;
            }
